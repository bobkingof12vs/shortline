...
var trainFunc = function(){
  ...
  this.moveBackOnPath = function(curDist, moveDist, path, curPointId, reverse){
    ...
    var moved = this.moveOnPath(curDist, moveDist, path, curPointId, 1, true);
    moved.rebuild = false;
    var prevPId = -1;
  ...
  this.moveOnPathDeprecated = function(curDist, moveDist, path, curPointId, reverse, reverseFlag){
    ...
    while(true){
      ...
      var checkPathTypeBin = path.previousP[0] === false ? 0x1 : 0x0;
      checkPathTypeBin += path.nextP[0] === false ? 0x2 : 0x0;
      checkPathTypeBin += reverse > 0 ? 0x4 : 0x0;
      checkPathTypeBin += moveDir == 1 ? 0x8 : 0x0;
      //console.log(checkPathTypeBin);
      //checkPathTypeBin += 'cpid: ' + curPointId + '/' + curPath.sec.points.length;

      console.log(checkPathType);
      /*if(reverseFlag == true && path.previousP[0] === false  && curPointId == 1 && moveDir == 1)
        var curPathPart = {
      ...
      else if(reverseFlag == true && path.previousP[0] === false && curPointId == plen - 2 && moveDir == 0){
        var curPathPart = {
          p1: curPath.sec.points[curPointId],
          p2: curPath.sec.points[curPointId + inc],
          p3: curPath.sec.points[curPointId + (2 * inc)],
      ...
      else*/ if(curPointId < -1 || curPointId > plen
      ...
      /*else if((path.previousP[0] === false && curPointId == 1 && reverse > 0 && moveDir == 0)
        ||  (path.nextP[0] === false && curPointId == plen - 2 && reverse < 0 && moveDir == 1)){
        var curPathPart = {
          p1: curPath.sec.points[curPointId],
          p2: curPath.sec.points[curPointId + inc],
          p3: curPath.sec.points[curPointId + (2 * inc)],
      ...
      else if(path.previousP[0] === false && reverse < 0 && curPointId >= plen && moveDir == 0)
        var curPathPart = {
          p1: curPath.sec.points[plen - 2],
      ...
      //reverse needs a few extra conditions
      else if(path.nextP[0] === false && reverse < 0 && curPointId == -1 && moveDir == 0)
        var curPathPart = {
          p1: curPath.sec.points[0],
          p2: midpoint(curPath.sec.points[1],curPath.sec.points[0]),
      ...
      else if(path.previousP[0] === false && reverse > 0 && curPointId == plen && moveDir == 1)
        var curPathPart = {
          p1: curPath.sec.points[plen - 1],
          p2: midpoint(curPath.sec.points[plen - 2],curPath.sec.points[plen - 1]),
          p3: curPath.sec.points[plen - 2],
      ...
      else if(path.nextP[0] === false && reverse < 0 && curPointId == plen && moveDir == 1)
        var curPathPart = {
          p1: curPath.sec.points[plen - 1],
          p2: midpoint(curPath.sec.points[plen - 2],curPath.sec.points[plen - 1]),
          p3: curPath.sec.points[plen - 2],
      ...
      else if(reverseFlag == true && path.nextP[0] !== false && reverse < 0 && curPointId == -1 && moveDir == 0)
        var curPathPart = {
          p1: path.nextP[0].sec.points[path.nextP[0].dir == 1 ? 1 : path.nextP[0].sec.points.length - 2],
          p2: curPath.sec.points[0],
          p3: curPath.sec.points[1],
      ...
      else if(reverseFlag == true && path.nextP[0] !== false && reverse < 0 && curPointId == plen && moveDir == 1)
        var curPathPart = {
          p1: path.nextP[0].sec.points[path.nextP[0].dir == 1 ? 1 : path.nextP[0].sec.points.length - 2],
          p2: curPath.sec.points[plen - 1],
          p3: curPath.sec.points[plen - 2],
      ...
      /*else if(reverseFlag == true && path.previousP[0] !== false && reverse < 0 && curPointId == -1 && moveDir == 1)
        var curPathPart = {
          p1: curPath.sec.points[1],
          p2: curPath.sec.points[0],
          p3: path.previousP[0].sec.points[path.previousP[0].dir == 0 ? 1 : path.previousP[0].sec.points.length - 2],
      ...
      else if(reverseFlag == true && path.previousP[0] === false && reverse > 0 && curPointId == -1 && moveDir == 0)
        console.warn('actually needed it');
        /*var curPathPart = {
          p1: curPath.sec.points[0],
          p2: midpoint(curPath.sec.points[1],curPath.sec.points[0]),
          p3: curPath.sec.points[1],
  ...
  this.workJobs = function(dTime){
    ...
    while(i < this.train.length - 1) {
      ...
      if(1 != 1 && this.train[i].engine.curSpeed > 0 && speedWas <= 0 && this.train[i].lastSpeed != 1){
        this.train[i].lastSpeed = 1;
        console.warn('changed here 1');

        this.train[i].curDist = this.train[i].curSegDist - this.train[i].curDist
        if(this.train[i].path.currentP.dir == 0)
          this.train[i].curPointId += 2
        else
          this.train[i].curPointId -= 2
      }
      else if(1 != 1 && this.train[i].engine.curSpeed < 0 && speedWas >= 0 && this.train[i].lastSpeed != -1){
        this.train[i].lastSpeed = -1;
        console.warn('changed here 2');
      ...
      this.train[i].curPointId = moved.pointId; // == -1 ? -3 : moved.pointId == this.train[i].path.currentP.sec.points.length ? this.train[i].path.currentP.sec.points.length + 2 : moved.pointId;
      this.train[i].curDist = moved.remDist;
      ...
      this.train[i].engine.backP = this.moveBackOnPath(
        ...
        this.train[i].path,
        /*(this.train[i].engine.curSpeed > 0
          && !(this.train[i].path.previousP[0] == false && this.train[i].curPointId == this.train[i].path.currentP.sec.points.length - 2 && this.train[i].path.currentP.dir == 0)
          && !(this.train[i].path.previousP[0] == false && this.train[i].curPointId == 1 && this.train[i].path.currentP.dir == 1)
        )
          ? (this.train[i].curPointId + ( -2 * (this.train[i].path.currentP.dir == 1 ? -1 : 1)))
          : */this.train[i].curPointId, //+ ( -2 * (this.train[i].path.currentP.dir == 1 ? -1 : 1)),
        -1
      ).pos
  ...
  this.moveOnPath = function(curDist, moveDist, path, curPointId, reverse, reverseFlag){
    curPath = path.currentP;
    nextP = path.nextP[0];
    prevP = path.previousP[0];
    ...
    while(true){
      ...
      var checkPathTypeBin = path.previousP[0] === false && reverse < 0 ? 0x1 : 0x0;
      checkPathTypeBin += path.nextP[0] === false ? 0x2 : 0x0;
      checkPathTypeBin += reverse > 0 ? 0x4 : 0x0;
      checkPathTypeBin += moveDir == 1 ? 0x8 : 0x0;
      //console.log(checkPathTypeBin);
