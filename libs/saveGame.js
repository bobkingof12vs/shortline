...
var saveGame = new (function(){
  ...
  this.save = function(email){
    ...
    var saveURL = 'http://184.101.40.47/shortline/trainserver/db.php?email='+email+'&type=add';
  ...
  this.load = function(id){
    ...
    var loadURL = 'http://184.101.40.47/shortline/trainserver/db.php?id='+id+'&type=get';
