...
var saveGame = new (function(){
  ...
  this.save = function(email){
    ...
    var saveURL = 'http://<html><head><title>404/shrtln/trainserver/db.php?email='+email+'&type=add';
  ...
  this.load = function(id){
    ...
    var loadURL = 'http://<html><head><title>404/shrtln/trainserver/db.php?id='+id+'&type=get';
