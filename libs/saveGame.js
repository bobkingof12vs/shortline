...
var saveGame = new (function(){
  ...
  this.save = function(email){
    ...
    var saveURL = 'http://63.225.203.101/shortline/trainserver/db.php?email='+email+'&type=add';
  ...
  this.load = function(id){
    ...
    var loadURL = 'http://63.225.203.101/shortline/trainserver/db.php?id='+id+'&type=get';
