...
var saveGame = new (function(){
  ...
  this.save = function(email){
    ...
    var saveURL = 'http://63.225.196.169/shrtln/trainserver/db.php?email='+email+'&type=add';
  ...
  this.load = function(id){
    ...
    var loadURL = 'http://63.225.196.169/shrtln/trainserver/db.php?id='+id+'&type=get';
