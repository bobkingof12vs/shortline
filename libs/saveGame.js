...
var saveGame = new (function(){
  ...
  this.save = function(email){
    ...
    var saveURL = 'http://68.3.223.66:33033/shortline/trainserver/db.php?email='+email+'&type=add';
  ...
  this.load = function(id){
    ...
    var loadURL = 'http://68.3.223.66:33033/shortline/trainserver/db.php?id='+id+'&type=get';
