...
var saveGame = new (function(){
  ...
  this.save = function(email){
    ...
    var saveURL = 'http://174.17.189.236/shortline/trainserver/db.php?email='+email+'&type=add';
  ...
  this.load = function(id){
    ...
    var loadURL = 'http://174.17.189.236/shortline/trainserver/db.php?id='+id+'&type=get';
