...
var saveGame = new (function(){
  ...
  this.save = function(email){
    ...
    var saveURL = 'http://71.209.147.26/shortline/trainserver/db.php?email='+email+'&type=add';
  ...
  this.load = function(id){
    ...
    var loadURL = 'http://71.209.147.26/shortline/trainserver/db.php?id='+id+'&type=get';
